...
<template>
  <div div v-if="errorMessage!==true" class="flex flex-col login gap-1">
      <div class="text-10 margin-2">Iniciar Sesión</div>
  ...
  <div v-else class="flex flex-col login gap-1text-10 margin-2">
    <div class="text-10 margin-1">Iniciando Sesión</div>
