...
<template>
    <div v-if="isUserLogged && (errorMessage !== true)">
        <div class="margin-2 flex flex-col align-center">
            <div class="text-10 margin-1">Editar Informacion de Pago</div>
        </div>
        <div class="flex align-center flex-col gap-1 margin-1">
            <div>Elije un Método de Pago</div>
            <pv-select-button v-model="userInfo.payment.selectedMethod" :options="myPaymentMethods"/>
        </div>
        <div class="flex align-center flex-col margin-1">
            ...
            <div class="flex flex-col margin-2" v-else-if="myPaymentMethods.indexOf(userInfo.payment.selectedMethod) === 1" >
            ...
            <div v-else class="flex flex-col margin-2">
                <div>Selecciona un método de pago para continuar</div>
            </div>
            <div class="flex flex-row gap-2 margin-2">
    ...
    <div v-else-if="errorMessage === true">
        <div class="margin-2 flex flex-col align-center">
            <div class="text-10 margin-1">{{this.originalUserInfo.payment.card.number || this.originalUserInfo.payment.wallet.id?"Actualizando Direccion...":"Creando Direccion..."}}</div>
